# Altium Designer Project for DC Motor Regulator

This directory contains the hardware design files for the DC Motor Regulator project, created using Altium Designer.

## Project Contents

*   **Schematics:** Detailed circuit diagrams for the microcontroller, motor driver interface, voltage dividers, and potentiometer connections.
*   **PCB Layout:** The physical layout of the printed circuit board, including component placement, routing, and board dimensions.
*   **Bill of Materials (BOM):** A list of all components required for assembling the PCB (typically generated from the schematic).
*   **Gerber Files:** Manufacturing files for PCB fabrication (can be generated from the PCB layout).
